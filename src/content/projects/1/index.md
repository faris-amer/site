...
![](/src/content/projects/1/falling-balls1.gif)
...
![](/src/content/projects/1/falling-balls2.png)
...
![](/src/content/projects/1/falling-balls3-1.png) ![](/src/content/projects/1/falling-balls3.gif)

Now, we add some collision code that keeps the ball in the stage, that goes as follows:

![](/src/content/projects/1/falling-balls4-1.png) ![](/src/content/projects/1/falling-balls4.gif)

It works! (first try, of course). But the balls don't know that the other balls exist yet; let's fix that.

![](/src/content/projects/1/falling-balls6.gif) 

This is fine, but when you let it run for a while....

![](/src/content/projects/1/falling-balls7.gif)
...
![](/src/content/projects/1/falling-balls8.gif)
