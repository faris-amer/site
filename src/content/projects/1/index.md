...
![](/media/pictures/projects/1/falling-balls1.gif)
...
![](/media/pictures/projects/1/falling-balls2.png)
...
![](/media/pictures/projects/1/falling-balls3-1.png) ![](/media/pictures/projects/1/falling-balls3.gif)

Now, we add some collision code that keeps the ball in the stage, that goes as follows:

![](/media/pictures/projects/1/falling-balls4-1.png) ![](/media/pictures/projects/1/falling-balls4.gif)

It works! (first try, of course). But the balls don't know that the other balls exist yet; let's fix that.

![](/media/pictures/projects/1/falling-balls6.gif) 

This is fine, but when you let it run for a while....

![](/media/pictures/projects/1/falling-balls7.gif)
...
![](/media/pictures/projects/1/falling-balls8.gif)
